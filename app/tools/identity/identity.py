...
# 导入常量并重命名
from app.tools.identity import constant
...
class IdNumber(str):
    ...
    def generate_id(cls, sex=0):
        ...
        # 限定出生日期范围(8位数)
        start, end = datetime.strptime("1960-01-01", "%Y-%m-%d"), datetime.strptime(
            "2000-12-30", "%Y-%m-%d"
        )
...
if __name__ == '__main__':
    ...
    print(IdNumber.verify_id('341282199401115518'))  # 检验身份证是否正确:False
